package CRP::Plugin::CSRFProtect;

# Modified version of Mojolicios::Plugin::CSRFProtect
# Doesn't add CSRF portection to GET forms (where it's useless and clutters up the URL)
